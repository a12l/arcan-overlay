{ stdenv, lib, fetchFromGitHub, meson, pkg-config, xorgproto, xtrans
, libxshmfence, pixman, xkbcomp, libxkbfile, libXfont2, dbus, systemd, fontutil
, mesa, epoxy, libmd, nettle, libgcrypt, openssl, libXdmcp, libdrm, libselinux
, audit, libGL, libtirpc, libXau, arcan, libxcb, ninja, libX11, xcbutil
, xcbutilwm, }:
